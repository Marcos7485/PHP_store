<div class="container hide">
    <div class="row my-5 text-center gold_text fade_in_effect">
        <div class="col-sm-6 offset-sm-3">
            <h3 class="text-center letra" style="font-size: 40pt; padding-top: 60px;">Encomenda confirmada!</h3>
            <p style="font-size: 15pt;">Muito obrigado por sua compra!</p>
            <div class="my-2">
                <h4>Dados de Pagamento:</h4>
                <p style="font-size: 20pt; color: goldenrod;">Em breve nos comunicaremos com você via WhatsApp para processar o pagamento</p>
