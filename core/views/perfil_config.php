<div class="container hide">
    <div class="row my-5 fade_in_effect">
        ...
        <div><img id="ant_fogo" class="fire-image" onclick="fogo()" src="/src/Efecto antorcha/fire4.gif"></div>
        <div><img class="antorcha" src="/src/Efecto antorcha/antorcha.png"></div>
        <div><img id="exp_imag" class="ex_imag" src="/src/Efecto antorcha/explosion.gif" style="display:none"></div>
        <?php endif ?>
    </div>
</div>
...
<div class="container show">
    <div class="row fade_in_effect">
        <h3 class="text-center letra gold_text" style="font-size: 30pt;">Perfil:</h3>
        <div class="col-1"></div>
...
stdClass Object
(
    [email] => llicorellapriorato@gmail.com
    [nome_completo] => Llicorella Priorato
    [morada] => Rua Dário João de Souza N° 61
    [cidade] => Florianópolis
    [telefone] => 48999906903
)
-->