...
<div class="container-fluid navegacao fixed-top hide">
    <div class="row textos">
        ...
        <div class="col-5 p-3 text-end gold_text align-self-center">
            <?php if (Store::vendedorLogado()) : ?>
                <i class="fas fa-user me-2"></i>
                <?= $_SESSION['vendedor_usuario'] ?>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-footer" style="background-color: black;">
                <button type="button" class="btn btn-success"><a href="?a=vendedor_logout" style="text-decoration: none; color:antiquewhite;">Logout</a></button>
