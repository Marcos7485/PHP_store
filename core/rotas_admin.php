...
$rotas=[
    ...
    'lista_sugerencias' => 'admin@lista_sugerencias',

    // encomendas
    'lista_encomendas' => 'admin@lista_encomendas',
    'lista_premios' => 'admin@lista_premios',
    'detalhe_premio' => 'admin@detalhe_premio',
    'detalhe_encomenda' => 'admin@detalhe_encomenda',
    'encomenda_alterar_estado' => 'admin@encomenda_alterar_estado',
    'premio_alterar_estado' => 'admin@premio_alterar_estado',
    'marcar_lido' => 'admin@marcar_lido',
];
